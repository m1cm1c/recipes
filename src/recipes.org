...
3. Den braunen Zucker hinzugeben.
...
4. Den Ingwer kurz mit anbraten.
...
|         | Pfeffer                                 |
*** Zubereitung
1. Die grünen Bohnen kurz in gesalzenem Wasser aufkochen lassen, 10 Minuten lang köcheln lassen, und dann absieben.
   - 10 Minuten Kochzeit sind wichtig um das in grünen Bohnen enthaltene Gift zu neutralisieren.
...
2. Die Eier der Länge nach halbieren.
3. Das Eigelb herausnehmen und in eine Schüssel geben.
4. Die anderen Zutaten zerkleinern, auch in die Schüssel geben, und alles vermischen.
   - Das Eigelb am besten mit einer Gabel zerdrücken.
5. Das gewürzte Eigelb zurück ins Eiweiß geben.
6. Die gefüllten Eier zusammen mit Brot servieren.
** Gegrillte Aubergine
*** Zutaten
| *Menge*     | *Zutat*               |
|-------------+-----------------------|
...
|             | Pfeffer               |
*** Zubereitung
1. Die Aubergine in ca. 8 mm dicke Scheiben schneiden.
   - Kann der Länge nach oder Breite nach erfolgen.
2. Die restlichen Zutaten zerkleinern, auf einen flachen Teller geben, und vermischen.
3. Die Auberginenscheiben in der Flüssigkeit marinieren.
4. Die marinierten Auberginenscheiben bei sehr hoher Temperatur in einer Pfanne anbraten.
** Gemüsebällchen mit Tomatensoße
*** Zutaten
|      *Menge* | *Zutat*                      |
|--------------+------------------------------|
|              | Reis                         |
| 1 Mixer voll | gehackte Tomaten             |
|              | Zucker                       |
|              | Zitronensaft                 |
|              | Olivenöl                     |
...
|              | Kirschtomaten                |
|              | Sonnenblumenöl               |
|    1 Packung | vegane Gemüsebällchen (Aldi) |
|          0.5 | Gurke                        |
|          0.5 | Paprika                      |
*** Zubereitung
1. Den Reis kochen.
2. Die Tomaten, den Zucker und den Zitronensaft zusammen pürieren.
3. Die Zwiebeln in Streifen schneiden und den Knoblauch zerkleinern.
4. Die Zwiebeln und den Knoblauch mit Olivenöl anbraten.
5. Das Kecap Manis hinzugeben und leicht karamellisieren lassen.
6. Die Sojasoße hinzugeben und auch kurz mitkochen lassen.
7. Die Tomatensoße hinzugeben.
8. Die Chillis, das Thai-Curry-Pulver, den Limettensaft und den Reisessig hinzugeben.
9. Die Soße kochen lassen.
10. Maggi und die Frühlingszwiebel (in Scheiben geschnitten) hinzugeben.
11. Die veganen Gemüsebällchen in einer Pfanne in Sonnenblumenöl braten.
12. Die Kirschtomaten hinzugeben und kurz mitkochen lassen.
13. Reis, Soße und Bällchen auf denselben Teller. Gurkenscheiben und Paprikastreifen separat angerichtet servieren.
** Gemüsebolognese
*** Zutaten
|                  *Menge* | *Zutat*                      |
|--------------------------+------------------------------|
...
3. Die Karotten mit anbraten.
4. Die Zucchini mit anbraten.
5. Mit den gehackten Tomaten ablöschen.
6. Die weiteren Zutaten hinzugeben und kurz köcheln lassen.
** Gemüsepfanne
*** Zutaten
|     *Menge* | *Zutat*                       |
|-------------+-------------------------------|
...
4. Die geschnittenen Bananen hinzugeben und alles verrühren.
5. Köcheln lassen, bis sich die Bananenscheiben größtenteils aufgelöst haben (ca. 10 Minuten).
** Indonesische Eier in Tomatensoße (Telur Balado)
*** Zutaten
| *Menge*     | *Zutat*          |
|-------------+------------------|
|             | Reis             |
...
2. Das Sonnenblumenöl und 0.5 Esslöffel Butter in die größte Pfanne geben und die Butter schmelzen lassen.
3. Den Teig in die große Pfanne geben und bei Stufe 6 (sonst verbrennt er) einen Pfannkuchen braten (dauert 15 Minuten). Nur 1 Pfannkuchen braten, auch wenn er sehr dick wird.
4. Den Pfannkuchen wenden und von der anderen Seite braten (dauert 5 Minuten).
...
| 800 g       | Kartoffeln                        |
| 1 Teelöffel | Salz                              |
| 440 g       | Brokkoli-Röschen oder Tk-Brokkoli |
| 1 Esslöffel | Sonnenblumenöl                    |
| 1 Esslöffel | Butter                            |
...
| 100 ml      | Milch                             |
| 200 ml      | Sahne                             |
| 3 Teelöffel | Gemüsebrühenpulver                |
| 2 Teelöffel | Senf                              |
...
2. Die Kartoffeln in 2 cm große Würfel schneiden.
3. Die Kartoffel-Würfel im größten Topf in mit 1 Teelöffel Salz gesalzenem Wasser kochen (10 Minuten Kochzeit ab Siede-Beginn bis der Brokkoli hinzukommt).
4. Die Zwiebel klein würfeln und den Knoblauch zerkleinern.
5. Den Brokkoli mit in den Topf geben und für weitere 5 Minuten köcheln lassen.
6. Das Sonnenblumenöl und die Butter in einen kleinen Topf geben. Die Zwiebel und den Knoblauch darin dünsten.
7. Den Inhalt des kleinen Topfes mit der Milch und der Sahne ablöschen.
8. Alle weiteren Zutaten bis auf den Gouda in den kleinen Topf geben und kurz aufkochen lassen.
9. Backofen vorheizen (180 °C; Umluft).
10. Die Kartoffeln und den Brokkoli absieben und in eine große Auflaufform geben.
11. Die Soße über den Kartoffeln und dem Brokkoli verteilen.
12. Den Gouda geschnitten in lange Streifen über den Inhalt der Auflaufform legen.
13. 25 Minuten lang backen.
** Kartoffelsalat
*** Zutaten
| *Menge*        | *Zutat*            |
|----------------+--------------------|
...
| 200 g       | Fadennudeln     |
*** Zubereitung
1. Vorbereitung: Den Lauch in Ringe schneiden.
...
*** Zubereitung
1. Die Spaghetti in der Mitte zerbrechen und ungekocht in die große Hälfte der Auflaufform legen.
...
|               | Wraps                    |
*** Zubereitung
1. Die Zutaten bis auf Tomatennmark, Käse, und Wraps in einer Schüssel (nicht der kleinsten) vermischen.
   - Falls Tomaten statt Tomatenmark verwendet werden, diese auch zum Vermischen in die Schüssel geben.
2. Pro Wrap:
   1. Den Wrap von beiden Seiten in der größten Pfanne anbraten bis er etwas dunkel geworden ist.
   2. Den Herd auf L stellen.
   3. Den Wrap ein letztes Mal wenden.
   4. Den Käse auf eine Hälfte des Wraps legen.
   5. Ein paar Löffel der Mischung aus der Schüssel auf den Käse geben.
   6. Falls Tomatenmark verwendet wird, dieses auf die Mischung geben.
   7. Die andere Hälfte des Wraps darüber falten.
   8. Den Wrap wenden und kurz anbraten.
   9. Den Wrap auf einen Teller geben.
3. Zum Schluss um die Wraps warm zu machen immer 2 auf einmal in die Pfanne geben.
** Schaschlik-Pfanne
*** Zutaten
| *Menge*           | *Zutat*               |
|-------------------+-----------------------|
...
| 2 Tassen          | Reis                  |
*** Zubereitung
1. Die Zwiebeln, den Paprika, und den Knoblauch würfeln und zur Seite legen. Die Chillischoten schneiden.
...
15. Wasser, Ketchup, Senf, Sojasoße, und Gemüsebrühenpulver hinzugeben.
...
|                       | Basilikum              |
*** Zubereitung
1. Die Schupfnudeln im Öl einige Minuten lang anbraten.
...
9. Den vorderen (zuvor unteren) Teil der Bambus-Matte vom restlichen Reis wegheben und unter weiterer Ausübung von (nun geringerem) Druck den weiteren mit Reis belegten Teil aufrollen.
10. Den oberen freien Teil des Nori-Blattes mit Wasser beschmieren.
11. Die Sushi-Rolle vollständig zusammenrollen.
12. Die Sushi-Rolle durch weiteres Rollen festigen.
13. Die Bambus-Matte an beiden Enden hochheben und die Sushi-Rolle nochmals leicht rollen lassen, um sie rund zu bekommen.
...
3. Die Erdnüsse und das rote Curry-Pulver hinzufügen und mit anbraten.
...
| 3           | Eier          |
*** Zubereitung
Wenn keine Mikrowelle verfügbar ist:
1. Die Milch und die Butter erhitzen, so dass die Butter schmilzt.
2. Die Mischung aus Milch und Butter in eine Schüssel geben.
...
2. Den Inhalt der Schüssel 1:30 Minuten lang bei 800 W in der Mikrowelle erwärmen.
...
2. Das Wasser hinzugeben und umrühren.
